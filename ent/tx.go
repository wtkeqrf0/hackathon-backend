...
func (tx *Tx) init() {
	tx.BusinessActivity = NewBusinessActivityClient(tx.config)
	...
	tx.TaxationSystem = NewTaxationSystemClient(tx.config)
...
// applies a query, for example: BusinessActivityId.QueryXXX(), the query will be executed
