...
const (
	...
	FieldID = "title"
	// FieldAvgCadastralVal holds the string denoting the avg_cadastral_val field in the database.
	FieldAvgCadastralVal = "avg_cadastral_val"
	...
	HistoriesColumn = "district_title"
)

// Columns holds all SQL columns for district fields.
var Columns = []string{
	FieldID,
	FieldAvgCadastralVal,
}
...
var (
	// AvgCadastralValValidator is a validator for the "avg_cadastral_val" field. It is called by the builders before save.
	AvgCadastralValValidator func(float64) error
)
...
// ByAvgCadastralVal orders the results by the avg_cadastral_val field.
func ByAvgCadastralVal(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAvgCadastralVal, opts...).ToFunc()
}
